...
class Parser:
    ...
    def parse_metadata(self, data, url=None):
        """Parse vote metadata."""
        ...
        vote_day = re.sub(
            r'(\d{4})(\d\d)(\d\d)', r'\1-\2-\3', data['abstimmtag']
        )
