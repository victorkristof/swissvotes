...
from .config import LEVELS, VOTES_METADATA_URL
...
class Client:
    ...
    def get_vote_metadata(self, url, file=None):
        ...
        return self._parser.parse_metadata(data, url)
    ...
    def get_results(self, url, level='municipality', file=None):
        ...
        # Parse vote results.
        data = self._get_json(url, file)
        return self._parser.parse_results(data, level)
